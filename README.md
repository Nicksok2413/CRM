...
2.  **Создайте и настройте `.env` файл:**
    ...
    **Важно:**
    ...
    (Опционально) Установите DSN для включения Sentry: **SENTRY_DSN**.
...
3.  **Соберите и запустите контейнеры:**
    ...
    **Что происходит при первом запуске автоматически:**
     ...
     - Создается группы (роли) всеми необходимыми правами доступа.

4.  **Приложение будет доступно по адресу:** `https://127.0.0.1`.
