...
class ProfileAdmin(admin.ModelAdmin):
    ...
    Хотя основной способ редактирования профиля - через пользователя,
    регистрация самой модели Profile полезна для просмотра списка всех
    профилей и для отладки.
    """
