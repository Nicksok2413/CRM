    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to=apps.common.utils.create_dynamic_upload_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png']), apps.common.validators.FileSizeValidator(max_size_mb=2), django_clamd.validators.validate_file_infection], verbose_name='Фото')),
            ],
            options={
