    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to=apps.common.utils.create_dynamic_upload_path, validators=[apps.common.validators.FileSizeValidator(max_size_mb=2), django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png'])], verbose_name='Фото')),
            ],
            options={
